    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table cellpadding="40px" cellspacing="40px">
        ...
        <!--   <td><input name="amount" value="<?php echo (empty($posted['amount'])) ? '' : $posted['amount'] ?>" /></td> -->
          ...
          <td>First Name: </td>
          <td><input name="firstname"  id="firstname" value="bhu" /></td>
            <td><input type="hidden" name="amount" value="200" /></td>
          </tr>
          <tr>
            <td>Email: </td>
            <td><input name="email"  id="email" value="bh11@gmail.com" /></td>
          <td>Phone: </td>
              <td><input name="phone"  value="1234567890" /></td>
        </tr>
        <tr>
          <td>Product Info: </td>
          <td colspan="3"><input name="productinfo"   value="dvdv"></input></td>
        </tr>
        <tr>
        <!--   <td>Success URI: </td> -->
          <td colspan="3"><input type="hidden" name="surl" value="http://localhost:8888/rental/rental_html/suc.html" size="64" /></td>
        </tr>
        <tr>
         <!--  <td>Failure URI: </td> -->
        <td colspan="3"><input type="hidden" name="furl" value="http://localhost:8888/rental/rental_html/fail.html" size="64" /></td>
        </tr>
        <tr>
